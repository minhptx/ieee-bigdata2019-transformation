...
class DatasetReport:
    ...
    def generate_report(self):
        report = {
            ...
            "s_valid_fn": self._validation_count([ValidationResult.FN]),
            "s_valid_fp": self._validation_count([ValidationResult.FP]),
            "s_valid_tn": self._validation_count([ValidationResult.TN]),
            "s_valid_tp": self._validation_count([ValidationResult.TP]),
        }
